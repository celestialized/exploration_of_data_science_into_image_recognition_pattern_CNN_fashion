...
def train():
    ...
    #fit data into model
    classifierCNN_train = classifierCNN.fit(Xtrain, Ytrain, epochs=100, batch_size=64, validation_data=(Xtest, Ytest))
    classifierCNN.save('model/classifier_cnn_pca_raw_csv_hetero_fashion_epoch100.h5py')
